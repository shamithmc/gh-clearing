...
paths:
  ...
  - "backend/src/test/java/com/airline/config/SecurityConfigTest.java"
  - "backend/src/test/java/com/airline/service/AuthenticatedUserProvisioningServiceTest.java"
